...
func GitHubCopilotDefaultModels() []*Model {
	return []*Model{
		...
		{ID: "gpt-5", Name: "GPT-5", Provider: "github-copilot", API: APIOpenAICompletions, Reasoning: true, Input: []InputModality{InputText, InputImage}, ContextWindow: 128000, MaxTokens: 128000},
		{ID: "gpt-5-mini", Name: "GPT-5-mini", Provider: "github-copilot", API: APIOpenAICompletions, Reasoning: true, Input: []InputModality{InputText, InputImage}, ContextWindow: 264000, MaxTokens: 64000},
		{ID: "gpt-5.1", Name: "GPT-5.1", Provider: "github-copilot", API: APIOpenAICompletions, Reasoning: true, Input: []InputModality{InputText, InputImage}, ContextWindow: 264000, MaxTokens: 64000},
		{ID: "gpt-5.1-codex", Name: "GPT-5.1-Codex", Provider: "github-copilot", API: APIOpenAICompletions, Reasoning: true, Input: []InputModality{InputText, InputImage}, ContextWindow: 400000, MaxTokens: 128000},
		{ID: "gpt-5.1-codex-max", Name: "GPT-5.1-Codex-max", Provider: "github-copilot", API: APIOpenAICompletions, Reasoning: true, Input: []InputModality{InputText, InputImage}, ContextWindow: 400000, MaxTokens: 128000},
		{ID: "gpt-5.1-codex-mini", Name: "GPT-5.1-Codex-mini", Provider: "github-copilot", API: APIOpenAICompletions, Reasoning: true, Input: []InputModality{InputText, InputImage}, ContextWindow: 400000, MaxTokens: 128000},
		{ID: "gpt-5.2", Name: "GPT-5.2", Provider: "github-copilot", API: APIOpenAICompletions, Reasoning: true, Input: []InputModality{InputText, InputImage}, ContextWindow: 264000, MaxTokens: 64000},
		{ID: "gpt-5.2-codex", Name: "GPT-5.2-Codex", Provider: "github-copilot", API: APIOpenAICompletions, Reasoning: true, Input: []InputModality{InputText, InputImage}, ContextWindow: 400000, MaxTokens: 128000},
		{ID: "gpt-5.3-codex", Name: "GPT-5.3-Codex", Provider: "github-copilot", API: APIOpenAICompletions, Reasoning: true, Input: []InputModality{InputText, InputImage}, ContextWindow: 400000, MaxTokens: 128000},
		{ID: "gpt-5.4", Name: "GPT-5.4", Provider: "github-copilot", API: APIOpenAICompletions, Reasoning: true, Input: []InputModality{InputText, InputImage}, ContextWindow: 400000, MaxTokens: 128000},
		{ID: "gpt-5.4-mini", Name: "GPT-5.4 mini", Provider: "github-copilot", API: APIOpenAICompletions, Reasoning: true, Input: []InputModality{InputText, InputImage}, ContextWindow: 400000, MaxTokens: 128000},
